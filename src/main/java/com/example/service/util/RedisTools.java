...
public class RedisTools<T> {
    ...
    public String getStringFromRedis(String key, String reason) {

        String  o1 = stringTemplate.opsForValue().get(key);
        if (Objects.equals(o1, "") ||o1==null) throw new ThreadLocalIsNullException(reason);
        return o1;
